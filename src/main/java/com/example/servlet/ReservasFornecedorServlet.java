...
@WebServlet("/ReservasFornecedorServlet")
public class ReservasFornecedorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            List<ReservaFornecedor> reservas = dao.listarReservasPorFornecedor(fornecedor.getIdFornecedor());
            request.setAttribute("reservas", reservas);
            request.getRequestDispatcher("ReservasFornecedor.jsp").forward(request, response);
        } catch (Exception e) {
